...
import { resolveEventFocus } from './nodeEventValueHelpers'
...
export const startCurrentPipelineNodeEvent = (params: {
  ...
  if (!activeNode) {
    activeNode = {
      ...
      reco_details: params.details.reco_details ? markRaw(params.details.reco_details) : undefined,
      ...
      next_list: [],
      node_details: params.details.node_details ? markRaw(params.details.node_details) : undefined,
    }
